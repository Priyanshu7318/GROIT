...
async def generate_images(prompt: str):
    tasks = []
    # Create 5 image generation tasks
    for _ in range(5):
        payload = {
...
while True:
    try:
        ...
        with open("Data/ImageGeneration.data", "r") as f:
            Data: str = f.read()
        ...
        if Status == "True":
            ...
            with open("Data/ImageGeneration.data", "w") as f:
                f.write("False,False")
...
# for testing purposes, you can uncomment the following line to generate images directly
